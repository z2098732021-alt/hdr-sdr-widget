...
param(
    ...
    [ValidateSet('Benchmark','Dda','Clarity','Docked','DockedLeft','Material','Record','Legacy')][string]$Mode='Benchmark',
...
$variables=@('HSDR_CONFIG_DIR','HSDR_STATUS_DUMP','HSDR_STATUS_DELAY','HSDR_STATUS_KEEP','HSDR_BENCHMARK','HSDR_NATIVE_TEST','HSDR_FORCE_DDA','HSDR_VISUAL_AUDIT','HSDR_RENDERER','HSDR_EDGE_TEST','HSDR_EDGE_LEFT','HSDR_MATERIAL_TEST','HSDR_RECORD')
$saved=@{}
